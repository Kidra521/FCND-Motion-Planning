...
from planning_utils import a_star, heuristic, create_grid, retrace_path, prune_path,expand_path
...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        current_local_position = global_to_local(self.global_position,global_home)
        ...
        pruned_path = expand_path(grid, grid_start, grid_goal, path, lookahead=10, epochs=1) 
        print('pruned_path length',len(pruned_path))
